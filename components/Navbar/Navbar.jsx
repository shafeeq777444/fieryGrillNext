...
const Navbar = ({ onClick }) => {
  ...
  return (
    <motion.nav
      ref={navbarRef}
      className={`fixed top-0 left-0 w-full z-50 px-6 py-4 md:py-6 font-balooTwo text-white transition-all duration-300 ease-in-out backdrop-blur-xs bg-[#1c1c1c] ${
