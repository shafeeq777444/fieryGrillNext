...
const SkeletonLoader = () => (
  <div className="absolute inset-0 z-[5] bg-gray-200 animate-pulse overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-r from-gray-300 via-gray-200 to-gray-300 animate-shimmer" />

    <div className="absolute top-1/2 right-6 transform -translate-y-1/2 hidden md:flex flex-col gap-6">
...
const Hero = () => {
  ...
  return (
    <div className="relative w-full h-[100vh] overflow-hidden">
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-[#00000088] bg-opacity-40 z-[5]"></div>
      ...
      <motion.div
        ...
        className="absolute top-1/2 right-6 -translate-y-1/2 space-y-4 z-[50] md:flex hidden flex-col gap-4"
      >
        <a
          href={contactDetails?.instagram}
          target="_blank"
          rel="noopener noreferrer"
          className="text-white text-2xl hover:text-[#EBB03F] transition"
        >
          <FaInstagram />
        </a>
        <a
      ...
      <motion.div
        ...
        className="absolute inset-0 flex flex-col items-center justify-center gap-6 px-6 text-center text-white z-[40]"
      >
